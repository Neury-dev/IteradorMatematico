 ...
 * @author neury
 */
public class FrontEvento {
    public static final SanFranciscoFireworks sanFranciscoFireworks = new SanFranciscoFireworks();
...
//            background = new ImageView(getClass().getResource("../front/img/sf.jpg").toExternalForm());
            background = new ImageView(getClass().getResource("/front/img/sf.jpg").toExternalForm());
        ...
        @Override protected void layoutChildren() {
            ...
            final double scale = Math.min(w/1500d, h/708d);
            final int width = (int)(1500*scale);
