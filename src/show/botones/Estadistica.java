 ...
 * @author neury
 */
public class Estadistica extends IteradorMatematico {
    //Paneles ------------------------------------------------------------------
    ...
    //Botones ------------------------------------------------------------------
    private static Button demoObjectStatic = new Button("Estadistica");
    
    public StackPane estadisticaEvento() {
        PERSONAL.toBack();
        FINANZA.toBack();
        GENERAL.toBack();
        ESTADISTICA.toFront();
        ...
        //ESTADISTICA.setStyle("-fx-background-color: transparent;");
        ...
        //Button demoObjectStatic = new Button("Estadistica");
        demoObjectStatic.setText("Estadistica");
        ...
        demoObjectStatic.setOnAction(new EventHandler<ActionEvent>(){
            @Override public void handle(ActionEvent t) {
                INNER_ESTADISTICA.toFront();
                INNER_ESTADISTICA.setVisible(true);
                INNER_ESTADISTICA.setStyle("-fx-background-color: white;");
                ...
                textField.setPromptText("Write here 4");
                ...
                atrasObject.setOnAction(new EventHandler<ActionEvent> () {
                    @Override public void handle(ActionEvent event) {
                        ...
                        INNER_ESTADISTICA.setVisible(false);
                    }
                });
                ...
                INNER_ESTADISTICA.getChildren().add(
                        gridPane
                );
        ...
        ESTADISTICA.getChildren().addAll(
